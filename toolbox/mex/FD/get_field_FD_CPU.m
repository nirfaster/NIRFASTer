% GET_FIELD_FD_CPU Solves sparse system of linear equations using BiCGStab 
%   solver and FSAI preconditioning. Parallelized for multithreading with
%   OpenMP. Uses all available CPU power.
% 
% SYNTAX:
%   [PHI] = GET_FIELD_FD_CPU(I_INDEX, J_INDEX, S_VALUE, QVEC)
%   [PHI] = GET_FIELD_FD_CPU(I_INDEX, J_INDEX, S_VALUE, QVEC, OPTIONS)
%   [PHI, INFO] = GET_FIELD_FD_CPU(___)
% 
%   [PHI] = GET_FIELD_FD_CPU(I_INDEX, J_INDEX, S_VALUE, QVEC) Solves a sparse
...
% 
%   [PHI, INFO] = GET_FIELD_FD_CPU(___) The
...
%
% See also GET_FIELD_FD_CUDA, GET_FIELD_TR_CPU, GET_FIELD_TR_CUDA,
