% GEN_MASS_MATRIX_TR_CPU Builds sparse matrices representation of
...
%   OpenMP. Uses all available CPU power. 
% 
% SYNTAX:
%   [I_INDEX, J_INDEX, S1_VALUE, S2_VALUE] = GEN_MASS_MATRIX_TR_CPU(MESH, DT)
%   [I_INDEX, J_INDEX, S1_VALUE, S2_VALUE] = GEN_MASS_MATRIX_TR_CPU(NODES, ELEMENTS, ...
...
%   [I_INDEX, J_INDEX, S1_VALUE, S2_VALUE] = GEN_MASS_MATRIX_TR_CPU(NODES, ELEMENTS, ...
%                                               BNDVTX, MUA, KAPPA, KSI, CM, DT)
%       Works as GEN_MASS_MATRIX_TR_CPU(MESH, DT). However, the input MESH
...
%        precision. 
% 
% GEN_MASS_MATRIX_TR_CPU was tested to give symmetric A1 (I_INDEX, J_INDEX,
% S1_VALUE) and A2 (I_INDEX, J_INDEX, S2_VALUE) matrices. 
%
% We use the follwing time-resolved diffusion transport equation notation:
%                                                           1       d 
...
% is the reduced scattering coefficient in mm^-1, PHI(r,t) is the fluence
...
% - gradient.
% GEN_MASS_MATRIX_TR_CPU transforms Eq. (1) into its matrix form of:
% 
%   A1 * PHI(r,t=0) =  S(r,t),
...
% 
% See also GEN_MASS_MATRIX_TR_CUDA, GET_FIELD_TR_CPU, GET_FIELD_TR_CUDA.
% 
%   MEX File function.
