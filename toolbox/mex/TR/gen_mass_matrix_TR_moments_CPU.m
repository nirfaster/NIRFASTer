% GEN_MASS_MATRIX_TR_MOMENTS_CPU Builds sparse matrices representation of
...
%   multithreading with OpenMP. Uses all available CPU power.
% 
% SYNTAX:
%   [I_INDEX, J_INDEX, S1_VALUE, S2_VALUE] = GEN_MASS_MATRIX_TR_MOMENTS_CPU(MESH)
%   [I_INDEX, J_INDEX, S1_VALUE, S2_VALUE] = GEN_MASS_MATRIX_TR_MOMENTS_CPU(NODES, ELEMENTS, ...
...
%    DOUBLE precision.
% 
% GEN_MASS_MATRIX_TR_MOMENTS_CPU was tested to give symmetric A1 (I_INDEX, J_INDEX,
...
% - gradient.
% GEN_MASS_MATRIX_TR_MOMENTS_CPU transforms Eq. (1) into the following
...
% 
% GEN_MASS_MATRIX_TR_MOMENTS_CPU returns sparse A1 and A2 matrices in COO
