% GET_FIELD_TR_CPU Solves time derivative of sparse system of linear
...
%   derivative steps. Parallelized for multithreading with OpenMP. Uses all
%   available CPU power.
...
%             /
% SYNTAX:
%   [PHI] = GET_FIELD_TR_CPU(I_INDEX, J_INDEX, S1_VALUE, S2_VALUE, QVEC, T, DT)
%   [PHI] = GET_FIELD_TR_CPU(I_INDEX, J_INDEX, S1_VALUE, S2_VALUE, QVEC, T, DT, OPTIONS)
%   [PHI, INFO] = GET_FIELD_TR_CPU(___)
% 
%   [PHI] = GET_FIELD_TR_CPU(I_INDEX, J_INDEX, S1_VALUE, S2_VALUE, QVEC, T, DT)
...
% 
%   [PHI, INFO] = GET_FIELD_TR_CPU(___) The
...
% 
% See also GEN_MASS_MATRIX_TR_CPU, GET_FIELD_TR_CUDA, GEN_MASS_MATRIX_TR_CUDA.
% 
% See also FEMDATA_TR, GEN_MASS_MATRIX_TR_CPU, GET_FIELD_TR_CUDA,
%          GEN_MASS_MATRIX_TR_CUDA, GET_FIELD_TR_BICGSTAB_MATLAB.
% 
