...
{
  double *nodes,*elements,*bndvtx,*mua,*kappa,*ksir,*c,*omega;
  ...
  c=mxGetPr(prhs[6]);              /*  speed of light in tissue, nodal */
  omega=mxGetPr(prhs[7]);          /*  frequency of excitation */
  ...
  mainloop(nodes,elements,bndvtx,mua,kappa,ksir,c,omega,nodem,noden,elemm,elemn,I,J,Sr,Si);
